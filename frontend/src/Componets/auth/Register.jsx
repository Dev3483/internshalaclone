  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await setDoc(doc(db, "users", user.uid), {
        ...
        lastName: lname,
        email: email,
        passwordChangeTimestamp: new Date(),
      });
...
<a onClick={handleGoogleSignIn} class="flex items-center h-9 justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
...
<div className="w-full p-8 lg:w-1/2">
<p onClick={handleGoogleSignIn} className='flex
 ...
 <div class="mt-4">
             ...
             <div class="mt-4">
                 <div class="flex justify-between">
                     ...
                     <button  className="text-xs text-blue-500">Forget Password?</button> 
...
<div className="w-full p-8 lg:w-1/2">
             ...
             <div class="mt-4">
                 <div class="flex justify-between">
                     <label class="block text-gray-700 text-sm font-bold mb-2">Password</label>
<button className="text-xs text-blue-500">Forget Password?</button>              </div>
                 <input class=" text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"   placeholder='Must be atleast 6 characters'   type="password"/>
             </div>
             <div className="mt-8">
             <button className='btn3  bg-blue-500 h-9 text-white font-bold py-2 px-4 w-full rounded hover:bg-blue-600 '>Login</button>
