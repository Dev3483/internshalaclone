    ...
    <div>
      <div className='hide'>
        ...
        <div className="flex justify-center" id='tabel'>
          <div className="applications flex flex-col mt-7 w-full">
                  ...
                  {userapplication.map((data) => (
                    <tr className='border-b' key={data._id}>
                      ...
                      <td className='whitespace-nowrap px-6 py-4'>
                        <Link to={`/User applicationDetail?a=${data._id}`}>
      ...
      <div className='show'>
        <h1 className='text-2xl font-semibold text-center'>View All Applications</h1>
        {userapplication.map((data) => (
                ...
                <div className="p-4 lg:w-1/2 md:w-full">
                  <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
                    ...
                    <div className="flex-grow">
                      ...
                      <Link to={`/User applicationDetail?a=${data._id}`} className="mt-3 text-indigo-500 inline-flex items-center">
                        View in detail
