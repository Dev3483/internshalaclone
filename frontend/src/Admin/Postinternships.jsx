        ...
        <div className="bg-white py-6 sm:py-8 lg:py-12">
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                <div className="mb-10 md:mb-16">
                    <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Post An Internship</h2>
                </div>
                ...
                <form className="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" onSubmit={sendData}>
                    ...
                    <div className="sm:col-span-2">
                        <label htmlFor="aboutInternship" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">About Internship*</label>
                    ...
                    <div className="sm:col-span-2">
                        <label htmlFor="stipend" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Stipend*</label>
                    ...
                    <div className="sm:col-span-2">
                        <button className="w-full bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-200">Post Job</button>
                    </div>
                </form>
            </div>
        </div>
